...
PACKAGE_TOP_DIR=libgexf-src.0.1.2/
...
cd "${TOP}"
makeDirectory ${TMPDIR}/libgexf-src.0.1.2/binding
copyFileToTmpDir "binding/build.sh" "${TMPDIR}/${PACKAGE_TOP_DIR}binding/build.sh" 0755

cd "${TOP}"
makeDirectory ${TMPDIR}/libgexf-src.0.1.2/binding/perl/Graph-LibGEXF
copyFileToTmpDir "binding/perl/Graph-LibGEXF/build.sh" "${TMPDIR}/${PACKAGE_TOP_DIR}binding/perl/Graph-LibGEXF/build.sh" 0755

cd "${TOP}"
makeDirectory ${TMPDIR}/libgexf-src.0.1.2/binding/perl/Graph-LibGEXF/inc/Module/Install
...
cd "${TOP}"
makeDirectory ${TMPDIR}/libgexf-src.0.1.2/binding/perl/Graph-LibGEXF/inc/Module
...
cd "${TOP}"
makeDirectory ${TMPDIR}/libgexf-src.0.1.2/binding/perl/Graph-LibGEXF/inc/Test
...
cd "${TOP}"
makeDirectory ${TMPDIR}/libgexf-src.0.1.2/binding/perl/Graph-LibGEXF/xt
...
cd "${TOP}"
makeDirectory ${TMPDIR}/libgexf-src.0.1.2/binding/perl/Graph-LibGEXF/t
...
cd "${TOP}"
makeDirectory ${TMPDIR}/libgexf-src.0.1.2/binding/perl/Graph-LibGEXF/lib/Graph
...
cd "${TOP}"
makeDirectory ${TMPDIR}/libgexf-src.0.1.2/binding/java
...
cd "${TOP}"
makeDirectory ${TMPDIR}/libgexf-src.0.1.2/binding/java/org/gephi/libgexf
...
cd "${TOP}"
makeDirectory ${TMPDIR}/libgexf-src.0.1.2/binding/python
...
cd "${TOP}"
makeDirectory ${TMPDIR}/libgexf-src.0.1.2/libgexf
...
cd "${TOP}"
makeDirectory ${TMPDIR}/libgexf-src.0.1.2
...
cd "${TOP}"
makeDirectory ${TMPDIR}/libgexf-src.0.1.2/nbproject
...
cd "${TOP}"
makeDirectory ${TMPDIR}/libgexf-src.0.1.2/nbproject/private
...
# Generate tar file
cd "${TOP}"
rm -f dist/Debug/GNU-Linux-x86/package/libgexf-src.0.1.2.tar
cd ${TMPDIR}
tar -vcf ../../../../dist/Debug/GNU-Linux-x86/package/libgexf-src.0.1.2.tar *
checkReturnCode
